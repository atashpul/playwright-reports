...
- Name: specs\Smoke\2-NavigationSmoke.spec.ts >> Application Navigation Smoke Tests >> Presented Checks page loads correctly
- Location: specs\Smoke\2-NavigationSmoke.spec.ts:35:5
...
Call log:
  - waiting for locator('input[placeholder="Email Address"]:visible').first()
    - locator resolved to <input name="_request.Email" data-testid="login-email" placeholder="Email Address" class="form-control form-control-lg valid" _bl_9fe9bdab-9c33-4196-9d51-130d98d049fe=""/>
