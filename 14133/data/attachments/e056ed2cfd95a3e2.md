...
- Location: specs\Smoke\7-ACHSmoke.spec.ts:285:5
...
Call log:
  - waiting for locator('input[placeholder="Email Address"]:visible').first()
    - locator resolved to <input name="_request.Email" data-testid="login-email" placeholder="Email Address" class="form-control form-control-lg valid" _bl_ad0d9718-5586-40f9-88f8-7d23a5495b53=""/>
