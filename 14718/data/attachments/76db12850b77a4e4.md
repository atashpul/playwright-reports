...
```
Error: page.goto: Navigation to "https://uat-positivepay.advancedfraudsolutions.com/auth/login" is interrupted by another navigation to "https://uat-positivepay.advancedfraudsolutions.com/auth/login/"
Call log:
...
```yaml
- main [ref=f6e2]:
  - heading [level=1] [ref=f6e4]
  - generic [ref=f6e7]:
    - generic [ref=f6e9]:
      - generic: Email *
      - textbox "Email Address" [ref=f6e10]
    - generic [ref=f6e12]:
      - generic: Password *
      - textbox "Password" [ref=f6e13]
    - button "Login to Positive Pay" [ref=f6e15] [cursor=pointer]
    - link "Forgot Password?" [ref=f6e17] [cursor=pointer]:
      - /url: /forgot-password/
```
