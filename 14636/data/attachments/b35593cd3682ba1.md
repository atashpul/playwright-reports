...
- Name: specs\Smoke\7-ACHSmoke.spec.ts >> ACH — Smoke >> "+ Add ACH" navigates to the add-ACH form
- Location: specs\Smoke\7-ACHSmoke.spec.ts:46:5
...
Call log:
  - waiting for locator('input[placeholder="Email Address"]:visible').first()
    - locator resolved to <input name="_request.Email" data-testid="login-email" placeholder="Email Address" class="form-control form-control-lg valid" _bl_4ff991e0-48eb-43aa-9272-4684a3b4d978=""/>
