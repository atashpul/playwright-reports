...
- Name: specs\Smoke\8-ExceptionsSmoke.spec.ts >> Exceptions — Smoke >> Page size change to 10 updates pagination info in bottom-right pager
- Location: specs\Smoke\8-ExceptionsSmoke.spec.ts:43:5
...
Call log:
  - waiting for locator('input[placeholder="Email Address"]:visible').first()
    - locator resolved to <input name="_request.Email" data-testid="login-email" placeholder="Email Address" class="form-control form-control-lg valid" _bl_acaaae53-2638-4509-847a-5702117c92d1=""/>
