...
- Name: specs\Smoke\1-LoginSmoke.spec.ts >> Validate forgot password functionality
- Location: specs\Smoke\1-LoginSmoke.spec.ts:107:1
...
Call log:
  - waiting for locator('//a[text()="Forgot Password?"]')
    - locator resolved to <a class="link" href="/forgot-password/">Forgot Password?</a>
...
```ts
  1   | import {Page,Locator} from '../../utility/index'
  2   | 
  ...
  9   | 
  10  |     
  11  |     //Get locator for email field
  12  |     
  13  |     get email(){
  14  |         return this.page.locator('input[placeholder="Email Address"]:visible').first();
  15  |     }
  16  | 
  17  |     //Get locator for email field on forgot password panel
  18  | 
  19  |     get forgotPasswordEmail(){
  20  |         return this.page.locator('div:has(a:has-text("Submit")) input[placeholder="Email Address"]:visible').first();
  21  |     }
  22  | 
  23  |     
  24  |      //Get locator for password field
  25  |      
  26  |     get password(){
  27  |         return this.page.locator('input[placeholder="Password"]');
  28  |     }
  29  | 
  30  |     
  31  |     // Get locator of login button 
  32  |     
  33  |     get loginButton(){
  ...
  36  | 
  37  |     
  38  |      //Get locator for submit button on forget password page
  39  |      
  40  |     get submitButtonOnForgotPasswordPage(){
  41  |         return this.page.locator('//span[text()="Submit"]');
  42  |     }
  43  | 
  44  |     
