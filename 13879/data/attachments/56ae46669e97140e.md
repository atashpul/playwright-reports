...
- Name: specs\Smoke\1-LoginSmoke.spec.ts >> Validate Login functionality with sqlInjection
...
- main [ref=e2]:
  ...
  - generic [ref=e7]:
    - generic [ref=e9]:
      - generic: Email *
      - textbox "Email Address" [ref=e10]: "' OR 1=1 --"
    - generic [ref=e12]:
      - generic: Password *
      - textbox "Password" [active] [ref=e13]: "' OR 1=1 --"
