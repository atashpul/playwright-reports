...
- Name: specs\Smoke\1-LoginSmoke.spec.ts >> Validate Login functionality with invalidEmailFormat
- Location: specs\Smoke\1-LoginSmoke.spec.ts:62:3
...
- generic [ref=e1]:
  - main [ref=e2]:
    ...
    - generic [ref=e7]:
      - generic [ref=e9]:
        - generic: Email *
        - textbox "Email Address" [ref=e10]: invalid-email-format
      - generic [ref=e12]:
        - generic: Password *
