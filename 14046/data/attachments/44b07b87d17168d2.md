...
- Name: specs\Smoke\4-IssuedChecksSmoke.spec.ts >> Issued Checks — Smoke >> Excel export button is visible and enabled
- Location: specs\Smoke\4-IssuedChecksSmoke.spec.ts:52:5
...
Call log:
  - waiting for locator('input[placeholder="Email Address"]:visible').first()
    - locator resolved to <input name="_request.Email" data-testid="login-email" placeholder="Email Address" class="form-control form-control-lg valid" _bl_0be70831-28a3-4a80-8fe7-ad841dc86fd1=""/>
